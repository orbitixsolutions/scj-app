import { WorkshopItem } from '@/app/(protected)/dashboard/(workshops)/workshops/_components/workshop-item'
import { WorkshopListProps } from '@/app/(protected)/dashboard/(workshops)/workshops/_components/workshop-list/workshop-list.type'
